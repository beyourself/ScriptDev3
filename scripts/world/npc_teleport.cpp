...
struct npc_teleport : public CreatureScript
{
	...
	bool OnGossipSelectWithCode(Player *pPlayer, Creature *pCreature, uint32 uiSender, uint32 uiAction, const char* sCode) override
	{
		return false;
	}
};
